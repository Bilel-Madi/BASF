...
type LayoutRouteId = RouteId | "/" | "/admin" | "/auth/onboarding" | "/auth/signup" | "/dashboard" | "/devices" | "/devices/add" | "/devices/[eui]" | "/organization" | "/projects" | "/projects/add" | "/projects/[project_id]" | "/zones" | "/zones/add" | "/zones/[zone_id]" | "/zones/[zone_id]/edit" | null
type LayoutParams = RouteParams & { eui?: string,project_id?: string,zone_id?: string }
