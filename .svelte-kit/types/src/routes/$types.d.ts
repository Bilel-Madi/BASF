...
type LayoutRouteId = RouteId | "/" | "/admin" | "/auth/signup" | "/dashboard" | "/devices" | "/devices/add" | "/devices/[eui]" | "/zones" | "/zones/[zone_id]" | null
type LayoutParams = RouteParams & { eui?: string,zone_id?: string }
